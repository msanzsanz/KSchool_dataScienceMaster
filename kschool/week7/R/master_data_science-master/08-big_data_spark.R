...
## spark se puede conectar a bigQuery
## mirar plataforma H20
...
# Leer del cluster
## Esto está subiendo la tabla flights a mi servidor de spark
...
# Bichear h2o + docker + digital ocean

# Esto lo envia a spark
