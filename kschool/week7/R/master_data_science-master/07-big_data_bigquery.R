...
project <- "firstproject-207408" # Pon aquí tu proyecto 
...
class(flights_db)
print(object.size(get('flights_db')), units='auto')
...
2,
3 )"
query_exec(sql, project = "firstproject-207408", use_legacy_sql = F)
...
#### IMPORTANTE
##
### En bigquery se pueden crear tablas referenciadas, donde el contenido no está
### en tablas propiamente dichas, sino que es una referencia a ficheros de google drive